...
def get_config():
    ...
    parser.add_argument("--use_test", default=False, help="test for the pre-trained-models.")
    ...
    parser.add_argument('--cluster_root_path', type=str, default='/data/jqruan/clustering-162/clustering/on-policy-mpe-161-20220301-group_test/onpolicy/scripts/results/MPE/simple_spread/rmappo_centroids/')
    ...
    parser.add_argument('--global_bis_agents_path', type=str, default='bis_agent_global._3640000.pt')
    parser.add_argument('--local_bis_agents_path', type=str, default='bis_agent._3640000.pt')
    ...
    parser.add_argument("--dbc_out_dim", type=int, default=16)

    # parser.add_argument("--not_update", default=False, help="not update.")
