...
root_path = '/home/jqruan/data/clustering/on-policy-mpe-161-20220301/onpolicy/scripts/results/MPE/simple_spread/rmappo/10agents/run1/models/'

add_data_bk_path = '/data2/jqruan/data/clustering/MPE/simple_spread/rmappo/10agents/run1/models/' ## 162
...
input_size, hidden_size, output_size = 60, 64, 64
...
log_dir = root_path + 'train_state_logs_emb64/' + transition_model_type + '_use_MI_'  if USE_MI else \
    root_path + 'train_state_logs_emb64/' + transition_model_type + '_' 
