...
root_path = '/home/jqruan/data/clustering/on-policy-mpe/onpolicy/scripts/results/MPE/simple_spread/rmappo/6agents/run2_eps50/models/'
add_data_bk_path = '/data2/jqruan/data/clustering/MPE/simple_spread/rmappo/6agents/run2_eps50/models/' ## 162
path_files = [
...
num_agents = 6
action_shape = 5
input_size, hidden_size, output_size = 36, 64, 16
