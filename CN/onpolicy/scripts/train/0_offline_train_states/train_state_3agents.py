...
root_path = '/home/jqruan/data/clustering/on-policy-mpe/onpolicy/scripts/results/MPE/simple_spread/rmappo/3agents/run1/models/'
path_files = [
...
num_agents = 3
action_shape = 5
input_size, hidden_size, output_size = 18, 64, 16
