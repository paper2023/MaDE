...
root_path = '/home/jqruan/data/clustering/on-policy-mpe/onpolicy/scripts/results/MPE/simple_spread/rmappo/8agents/run2_eps80/models/'
add_data_bk_path = '/data2/jqruan/data/clustering/MPE/simple_spread/rmappo/8agents/run2_eps80/models/' ## 162
path_files = [
...
num_agents = 8
action_shape = 5
input_size, hidden_size, output_size = 48, 64, 16
