...
for data_load_index in range(8, 9, 1):
    ...
    dirs_all = [['ensemble__[02-18]08.51.17', 'ensemble__shuffle_[02-18]08.51.14',
                ...
                ['ensemble__[03-07]17.39.36', 'ensemble__shuffle_[03-07]17.39.24',
                'ensemble_use_MI__[03-07]17.39.17', 'ensemble_use_MI__shuffle_[03-07]17.39.09']
    ]
    ...
    model_nums_all = [
        ...
        [2880000, 2960000, 2700000, 2320000],
        [234360, 234360, 234360, 234360],
        [351540, 351540, 351540, 351540],
        [468750, 468750, 468750, 468750],
        # [585930, 585930, 585930, 585930]
        # [300000, 300000, 300000, 300000]
        # [1440000, 700000, 1160000, 820000]
        # [2140000, 1260000, 1800000, 1400000]
        [3640000, 2440000, 3240000, 2680000]
    ]
    ...
    action_shape = 5
    input_size, hidden_size, output_size = input_sizes_[data_load_index], 64, 64 # 4:(24, 64, 16)
    ...
    # root_ = '/home/jqruan/data/clustering/on-policy-mpe/onpolicy/scripts/results/MPE/simple_spread/rmappo/' + str(num_agents) + 'agents/run1/models/'
    # root_path = root_ + '/train_state_logs/'
