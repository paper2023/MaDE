...
root_path = '/home/jqruan/data/clustering/on-policy-mpe-161-20220301/onpolicy/scripts/results/MPE/simple_spread/rmappo/4agents/run1/models/'


add_data_bk_path = '/data2/jqruan/data/clustering/MPE/simple_spread/rmappo/4agents/run1/models/' ## 162
path_files = [
