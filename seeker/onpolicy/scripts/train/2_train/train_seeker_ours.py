...
if __name__ == "__main__":
    for i in range(0, 5):   ### threads 64
        ...
        experiment_name = num_agents + 'agents_' + args[3] + '_ours' + '_num_4'
        ...
        args[13]=str(i)### seed
        main(args)
        ### conda activate pyg; cd /data/jqruan/clustering/on-policy-seeker-161-20230320/onpolicy/scripts/train/2_train
        ### CUDA_VISIBLE_DEVICES=2 python train_seeker_ours.py
