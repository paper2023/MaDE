...
if __name__ == "__main__":
    for i in range(0, 5):
        ...
        '--seed', '1', '--n_training_threads', '8', '--n_rollout_threads', '64', '--num_mini_batch', '2', '--episode_length', '50', '--num_env_steps', '6000000', 
        ...
        experiment_name = num_agents + 'agents_' + args[3] + '_debug'
