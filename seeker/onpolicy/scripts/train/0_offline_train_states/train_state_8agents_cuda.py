...
root_path = '/home/jqruan/data/clustering/on-policy-mpe-161-20220301/onpolicy/scripts/results/MPE/simple_spread/rmappo/8agents/run1/models/'
add_data_bk_path = '/data2/jqruan/data/clustering/MPE/simple_spread/rmappo/8agents/run1/models/' ## 162
path_files = [
...
# s, 1, 1, s, 1, 8s, 8s, 8 = 875
# 11+18s = 875
num_agents = 8
action_shape = 5
# input_size, hidden_size, output_size = 48, 64, 16
input_size, hidden_size, output_size = 48, 64, 32
...
log_dir = root_path + 'train_state_logs_emb32/' + transition_model_type + '_use_MI_'  if USE_MI else \
    root_path + 'train_state_logs_emb32/' + transition_model_type + '_' 
