...
root_path = '/home/jqruan/data/clustering/on-policy-mpe/onpolicy/scripts/results/MPE/simple_spread/rmappo/6agents/run1/models/'
add_data_bk_path = '/data2/jqruan/data/clustering/MPE/simple_spread/rmappo/6agents/run1/models/' ## 162
path_files = [
