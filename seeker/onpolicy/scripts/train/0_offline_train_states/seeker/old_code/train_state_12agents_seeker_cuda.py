...
add_data_bk_path = '/data2/jqruan/data/clustering/seeker/rmappo/12agents/' ## 162
path_files = [
    'o_a_r_o_prime_done_s_s_prime_u-slices_1-num_1000.npy',
    # 'o_a_r_o_prime_done_s_s_prime_u-slices_2-num_1000.npy',
    # 'o_a_r_o_prime_done_s_s_prime_u-slices_3-num_1000.npy',
    # 'o_a_r_o_prime_done_s_s_prime_u-slices_4-num_1000.npy',
    # 'o_a_r_o_prime_done_s_s_prime_u-slices_5-num_1000.npy'
]
...
bis_agent_global = BisimAgent(global_size, hidden_size, output_size, joint_action_shape, transition_model_type).cuda()
