...
root_path = '/home/jqruan/data/clustering/on-policy-seeker-161-20230320/onpolicy/scripts/train/results_ours/seeker/3agents/3agents_rmappo/seed_0_run1/models/'
root_path = '/home/jqruan/data/clustering/on-policy-seeker-161-20230320/onpolicy/scripts/train/results_ours/seeker/3agents/3agents_mappo/seed_1_run1/models/'
...
# add_data_bk_path = '/data/jqruan/data/clustering/seeker/rmappo/3agents/' ## 162
# path_files = [
#     'o_a_r_o_prime_done_s_s_prime_u-slices_1-num_10000.npy',
#     'o_a_r_o_prime_done_s_s_prime_u-slices_2-num_10000.npy',
#     'o_a_r_o_prime_done_s_s_prime_u-slices_3-num_10000.npy',
#     'o_a_r_o_prime_done_s_s_prime_u-slices_4-num_10000.npy'
# ]

# add_data_bk_path = '/data/jqruan/data/clustering/seeker/mappo/3agents/' ## 162
# path_files = [
#     'o_a_r_o_prime_done-slices_1-num_1000.npy',
#     'o_a_r_o_prime_done-slices_2-num_1000.npy',
#     'o_a_r_o_prime_done-slices_3-num_1000.npy',
#     'o_a_r_o_prime_done-slices_4-num_1000.npy',
#     'o_a_r_o_prime_done-slices_5-num_1000.npy'
# ]


add_data_bk_path = '/data/jqruan/data/clustering/seeker/mappo/3agents/data_all/' ## 162
path_files = [
...
log_dir = root_path + 'train_state_logs/emb_' + str(output_size) + '_files_epo_no_global/' + transition_model_type + '_use_MI_'  if USE_MI else \
    root_path + 'train_state_logs/emb_' + str(output_size) + '_files_epo_no_global/' + transition_model_type + '_' 
