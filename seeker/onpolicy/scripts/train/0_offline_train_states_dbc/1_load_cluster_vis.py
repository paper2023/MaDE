...
dirs_all = ['[03-11]11.41.52', '[03-11]11.41.54', '[03-11]11.42.01', '[03-11]11.41.58', '[03-11]11.41.56']
model_nums_all = [292950, 390600, 585900, 781250, 976550]

log_names = 'dbc_cluster'

dirs, model_nums = dirs_all[data_load_index], model_nums_all[data_load_index]

dones_ = ['/data2/jqruan/data/clustering/MPE/simple_spread/rmappo/3agents/run1/models/o_a_r_o_prime_done_s_s_prime_u-num_25432_done.npy', 
...
root_path = root_ + '/train_state_logs_dbc/ensemble/'
...
path_model = root_path + dirs + '/models_ensemble/' + '/bis_agent._' + str(model_nums) + '.pt'
...
save_path = root_path + dirs + '/models_ensemble/' + log_names
if not os.path.isdir(save_path):
    os.mkdir(save_path)

fig.savefig(save_path+'/kmeans_{}_samples_{}_clusters_{}_model.png'.format(sample_num, n_clusters, model_nums), dpi=600, format='png')
