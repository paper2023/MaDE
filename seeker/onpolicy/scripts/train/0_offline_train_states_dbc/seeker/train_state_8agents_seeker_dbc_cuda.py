...
root_path = '/data/jqruan/clustering/on-policy-seeker-161-20230320/onpolicy/scripts/train/results_ours/seeker/8agents/8agents_rmappo/seed_1_run1/models/'
add_data_bk_path = '/data/jqruan/data/clustering/seeker/mappo/8agents/' ## 162
path_files = [
    'o_a_r_o_prime_done_s_s_prime_u-slices_1-num_2000_random.npy',
    'o_a_r_o_prime_done_s_s_prime_u-slices_2-num_2000_random.npy',
    'o_a_r_o_prime_done_s_s_prime_u-slices_3-num_2000_random.npy',
    'o_a_r_o_prime_done_s_s_prime_u-slices_4-num_1000_random.npy',
    'o_a_r_o_prime_done_s_s_prime_u-slices_5-num_1000_random.npy',
    'o_a_r_o_prime_done_s_s_prime_u-slices_6-num_1000_random.npy',
    'o_a_r_o_prime_done_s_s_prime_u-slices_7-num_1000_random.npy',
    'o_a_r_o_prime_done_s_s_prime_u-slices_8-num_1000_random.npy',
    'o_a_r_o_prime_done_s_s_prime_u-slices_9-num_1000_random.npy', ## 12
    'o_a_r_o_prime_done_s_s_prime_u-slices_10-num_1000_random.npy',
    'o_a_r_o_prime_done_s_s_prime_u-slices_11-num_1000_random.npy',
    'o_a_r_o_prime_done_s_s_prime_u-slices_12-num_1000_random.npy'
    
]
input_size, hidden_size, output_size = 275, 128, 64
...
for i in path_files:
    ...
    torch.save(bis_agent.state_dict(), '%s/bis_agent._%s.pt' % (save_path, train_step))
        ...
        # CUDA_VISIBLE_DEVICES=2 python train_state_8agents_seeker_dbc_cuda.py
