...
for data_load_index in range(1, 2, 1):
    
    dirs_all = [
        [
        '/3agents/3agents_mappo/seed_1_run1/models/train_state_logs/emb_64_files_epo_no_global/ensemble_use_MI__shuffle_[04-12]09.46.21',
      ],
        # [
        #     '/5agents/5agents_mappo/seed_1_run1/models/train_state_logs/emb_64/ensemble__[04-21]00.24.39',
        #     '/5agents/5agents_mappo/seed_1_run1/models/train_state_logs/emb_64/ensemble__shuffle_[04-21]00.24.25',
        #     '/5agents/5agents_mappo/seed_1_run1/models/train_state_logs/emb_64/ensemble_use_MI__[04-21]00.24.08',
        #     '/5agents/5agents_mappo/seed_1_run1/models/train_state_logs/emb_64/ensemble_use_MI__shuffle_[04-21]00.23.47'
        # ],
        [
            '/5agents/5agents_mappo/seed_1_run1/models/train_state_logs/emb_64/ensemble__[05-10]11.36.33',
            '/5agents/5agents_mappo/seed_1_run1/models/train_state_logs/emb_64/ensemble__shuffle_[05-10]11.36.16',
            '/5agents/5agents_mappo/seed_1_run1/models/train_state_logs/emb_64/ensemble_use_MI__[05-10]11.36.01',
            '/5agents/5agents_mappo/seed_1_run1/models/train_state_logs/emb_64/ensemble_use_MI__shuffle_[05-10]11.35.35',
            '/5agents/5agents_mappo/seed_1_run1/models/train_state_logs/emb_64/ensemble_use_MI__shuffle_[05-10]20.14.44',
        ],
        [
            '/8agents/8agents_rmappo/seed_1_run1/models/train_state_logs/emb_64/ensemble__[04-27]14.16.19',
            '/8agents/8agents_rmappo/seed_1_run1/models/train_state_logs/emb_64/ensemble_use_MI__shuffle_[04-28]17.36.38',    
        ],
        [
            '/12agents/12agents_rmappo/seed_1_run1/models/train_state_logs/emb_64/ensemble__[04-23]12.48.30',
            '/12agents/12agents_rmappo/seed_1_run1/models/train_state_logs/emb_64/ensemble_use_MI__shuffle_[04-23]12.48.10'
        ]
    ...
    log_names_all = [
        ['MI_shuffle'],
        ['no_MI_no_shuffle', 'no_MI_shuffle', 'MI_no_shuffle', 'MI_shuffle', 'MI_shuffle'],
        ['no_MI_no_shuffle', 'MI_shuffle'],
        ['no_MI_no_shuffle', 'MI_shuffle']
    ]
    ...
    model_nums_all = [
        [2500000],
        [
            [20000, 40000, 60000], # 'no_MI_no_shuffle', 
            [200000, 440000, 880000, 2180000], # 'no_MI_shuffle', 
            [20000, 40000, 60000], # 'MI_no_shuffle', 
            [200000, 440000, 880000, 2000000],  # 'MI_shuffle'
            # [200000, 440000, 880000, 1300000]  # 'MI_shuffle'
            [20000, 60000, 100000, 150000, 200000]  # 'MI_shuffle'
        ],
        [
            [200000, 400000, 600000, 800000,],  # 'no_MI_no_shuffle', 
            [200000, 800000, 1440000, 2180000, 3720000]   # 'MI_shuffle'
        ],
        [
            [200000, 800000, 1440000, 2440000],  # 'no_MI_no_shuffle', 
            [200000, 800000, 1440000, 2180000]   # 'MI_shuffle'
        ]
    ...
    dones_ = [
        '/data/jqruan/data/clustering/seeker/mappo/3agents/data_all/o_a_r_o_prime_done_s_s_prime_u-slices_1-num_5000_random.npy',
        # '/data/jqruan/data/clustering/seeker/rmappo/5agents/o_a_r_o_prime_done_s_s_prime_u-slices_1-num_1000.npy',
    ...
    for i_ in index:
        ...
        for m_n in model_nums_:
            ...
            np.save(save_path + '/sample_data_2w_centroids_10.npy', centroids, allow_pickle=True)
            ...
            np.save(save_path + '/sample_data_2w_edges_10_10.npy', edges, allow_pickle=True)
