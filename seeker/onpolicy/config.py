...
def get_config():
    ...
    parser.add_argument("--n_eval_rollout_threads", type=int, default=4,
    ...
    parser.add_argument("--use_test", action='store_false', default=False, help="test for the pre-trained-models.")
    ...
    parser.add_argument("--test_model_path", type=str, default=None, help="by default None. set the path to pretrained model.")
    parser.add_argument("--test_save_path", type=str, default=None, help="by default None. set the path to pretrained model.")
    
    ###### clustering parameters
    # parser.add_argument('--num_agents', type=int, default=3)
    parser.add_argument("--use_graph", action='store_false', default=True, help="use graph ours")
    parser.add_argument('--n_latent_landmarks', type=int, default=10)
    parser.add_argument('--obs_size', type=int, default=0)
    parser.add_argument('--learned_prior', action='store_true')
    parser.add_argument('--elbo_beta', type=float, default=1.0)
    parser.add_argument('--cluster_lr', type=float, default=3e-4)
    parser.add_argument('--cluster_std_reg', type=float, default=0.0)
    
    parser.add_argument('--cluster_root_path', type=str, default='/home/jqruan/data/clustering/on-policy-mpe-161-20220301/onpolicy/scripts/results/MPE/simple_spread/rmappo_centroids/')
    # parser.add_argument('--cluster_last_path', type=str, default='agents/emb64/no_MI_no_shuffle/')
    
    parser.add_argument('--cluster_last_path', type=str, default='agents/emb64/MI_no_shuffle/')
    # parser.add_argument('--cluster_last_path', type=str, default='agents/emb16/MI_shuffle/')
    parser.add_argument('--cluster_centroids_path', type=str, default='sample_data_2w_centroids_10.npy')
    parser.add_argument('--cluster_edges_path', type=str, default='sample_data_2w_edges_10_10.npy')
    ...
    parser.add_argument('--global_bis_agents_path', type=str, default='')
    parser.add_argument('--local_bis_agents_path', type=str, default='')
    parser.add_argument("--use_joint_train", type=bool, default=False, help="pre-trained bisimulation jointly training")
    
    parser.add_argument('--group_num', type=int, default=2)
    
    #### dbc
    parser.add_argument("--use_dbc", action='store_true', default=False, help="dbc baseline.")
    parser.add_argument("--dbc_out_dim", type=int, default=64)
    
    parser.add_argument("--random_collect", default=False, help="collect datasets using random policy .")




    parser.add_argument("--abl_flag", default='', type=str, help="消融实验.") # abl_flag=0 删除 态势图   # abl_flag=1 删除组别  # abl_flag=2 删除obs
